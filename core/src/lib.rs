...
#[openapi(
    ...
    components(
        schemas(
            ...
            models::chunkr::upload::SegmentProcessing,
            models::chunkr::upload::SegmentProcessingConfig,
            models::chunkr::upload::SegmentProcessingConfigLLM,
            models::chunkr::upload::GenerationStrategy,
