...
#[openapi(
    ...
    components(
        schemas(
            models::chunkr::upload::Configuration,
            models::chunkr::upload::Model,
            models::chunkr::upload::OcrStrategy,
            models::chunkr::upload::UploadForm,
            models::chunkr::upload::SegmentationStrategy,
            models::chunkr::segment::BoundingBox,
            models::chunkr::segment::Chunk,
            models::chunkr::segment::OCRResult,
            models::chunkr::segment::OutputResponse,
            models::chunkr::segment::Segment,
            models::chunkr::segment::SegmentType,
            models::chunkr::task::Status,
            models::chunkr::task::TaskResponse,
            utils::services::structured_extraction::JsonSchema,
            utils::services::structured_extraction::Property,
            utils::services::structured_extraction::ExtractedJson,
            utils::services::structured_extraction::ExtractedField,
        )
    ),
