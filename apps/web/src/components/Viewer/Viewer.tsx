...
export default function Viewer({
  ...
  // Add click outside handler for download dropdown and config dropdown
  useEffect(() => {
    function handleClickOutside(event: MouseEvent) {
      ...
      if (
        !event.target ||
        !(event.target as Element).closest(".config-dropdown-container")
      ) {
        setShowConfig(false);
      }
    }
  ...
  const renderDownloadDropdown = () => (
    ...
    >
      ...
      >
        ...
        >
          <g clipPath="url(#clip0_304_23621)">
            <path
      ...
      {!hideHeader && (
        ...
        >
          ...
          <Flex className="viewer-header-right-buttons" gap="16px">
            ...
            <div
              className="config-dropdown-container"
              style={{ position: "relative" }}
            >
              <BetterButton
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clipPath="url(#clip0_304_23691)">
                    <path
