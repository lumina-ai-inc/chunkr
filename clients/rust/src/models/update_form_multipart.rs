...
pub struct UpdateFormMultipart {
    ...
    pub chunk_processing: Option<Option<Box<models::UpdateFormMultipartChunkProcessing>>>,
    ...
    pub segment_processing: Option<Option<Box<models::UpdateFormMultipartSegmentProcessing>>>,
...
impl UpdateFormMultipart {
    pub fn new() -> UpdateFormMultipart {
        UpdateFormMultipart {
