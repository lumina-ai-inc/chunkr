...
impl LlmGenerationConfig {
    ...
    pub fn new() -> LlmGenerationConfig {
        LlmGenerationConfig {
            crop_image: None,
            embed_sources: None,
            html: None,
