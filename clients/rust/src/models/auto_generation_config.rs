...
pub struct AutoGenerationConfig {
    ...
    pub html: Option<Box<models::AutoGenerationConfigHtml>>,
    ...
    pub markdown: Option<Box<models::AutoGenerationConfigHtml>>,
}

impl AutoGenerationConfig {
    ...
    pub fn new() -> AutoGenerationConfig {
